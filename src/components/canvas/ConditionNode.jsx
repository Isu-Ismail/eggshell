...
import { Eye, Trash2, ListChecks } from 'lucide-react';
    ...
    <div className={styles.node}>
      ...
      <div className={styles.capsule}>
        <div className={styles.titleWrapper}>
          <ListChecks size={11} className={styles.titleIcon} />
          <span className={styles.title}>COND</span>
        </div>
        <div className={styles.actions}>
          <button 
            className={styles.iconBtn} 
            onClick={() => setInspectorNodeId(id)} 
            title="Inspect & Edit Conditional Logic"
          >
            <Eye size={12} />
          </button>
          <button 
